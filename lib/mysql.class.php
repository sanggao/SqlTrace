...
class mysql
{
    ...
    function __construct($charset = 'utf8', $pconnect = 0, $quiet = 0)
    {   
        $config = include('./config/config.php');
        $this->msyql($config['dbhost'], $config['dbuser'], $config['dbpw'], $config['dbname'], $charset, $pconnect, $quiet);
    }

    function msyql($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'utf8', $pconnect = 0, $quiet = 0)
    {
